...
- Các migration `20260912010000`, `20260912020000` và `20260913010000` đã được áp dụng bằng kết nối PostgreSQL của dự án.
...
Script DB dùng `DIRECT_URL` trong `.env.local`, xác thực TLS với CA của Supabase. Có thể chỉ định CA tải từ dashboard bằng `DATABASE_CA_CERT_PATH`. Không chạy các kiểm thử tạo tài khoản/nhóm thật trên production.
